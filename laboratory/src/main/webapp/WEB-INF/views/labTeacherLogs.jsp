...
<header>
 <nav class="navbar navbar-inverse navbar-fixed-top"">
  ...
  <div class="row">
     ...
     <div class="col-md-9">
        <div class="jumbotron">
         <p class="text-right small">实验室老师页面</p><br/>
       </div>
       
       <div class="panel panel-primary" >
             <div class="panel-heading">单个实验室申请日志统计显示</div>
 ...
 <footer>
  ...
  <script type="text/javascript">
    ...
    function to_page(pn){
        $("#logs_context").empty();
        $.ajax({
            url:"${APP_PATH}/LogsController/labTeacherLogs",
            data:{pn:pn,labname:labname},
            type:"GET",
            success:function(result){
                 ...
                 $.each(logs,function(index,item){
                     ...
                     findRecordAndShowLogs(item.rId,condition,labname);
                 });
               //2.解析并显示分页信息
    ...
    $(document).ready(function(){
    	var sessionUsername = $("#strongUsername").text();
    	 getlabnameByUsername(sessionUsername);
        to_page(1);
    });
    
    //先获取实验室教师负责的实验室的labname，然后在通过比对得到专属实验室的日志记录
    function getlabnameByUsername(sessionUsername){
    	$.ajax({
