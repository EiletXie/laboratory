     ...
     <div class="col-md-9">
        <div>
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">事务提醒</a></li>
            <li role="presentation"><a href="#apply_tabpanel" aria-controls="apply_tabpanel" role="tab" data-toggle="tab">申请信息</a></li>
            <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">系统通知</a></li>
          </ul>
        
          <!-- Tab panes -->
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">...</div>
            <div role="tabpanel" class="tab-pane" id="apply_tabpanel">
               ...
               <table class="table table-hover" id="messages_table">
                    <thead>
                      <tr>
                        ...
                        <th width="50%">标题</th>
                        <th>时间<span class="glyphicon glyphicon-arrow-down" aria-hidden="true"></span></th>
                      </tr>
                     </thead>
                     <tbody>
                      <!-- 通过ajax建立表格数据 -->
